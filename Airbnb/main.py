...
icon = Image.open(r"C:\Users\HP\Desktop\Airbnb\icn.png")
st.set_page_config(page_title= "Airbnb Data Visualization | By Prerana",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Prerana*!
...
df = pd.read_csv(r'C:\Users\HP\Desktop\Airbnb\Airbnb_data.csv')

# HOME PAGE
if selected == "Home":
    # Title Image
    title_image = Image.open(r"C:\Users\HP\Desktop\Airbnb\TITLE.png")
    ...
    col2.markdown("#   ")
    col2.markdown("#   ")
    home_image = Image.open(r"C:\Users\HP\Desktop\Airbnb\home.png")
    col2.image(home_image)
